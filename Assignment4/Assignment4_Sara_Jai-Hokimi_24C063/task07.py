...
Original file is located at
    https://colab.research.google.com/drive/1b-NvYupIS_s-WTQwdeBu8j3Z_y3BcZZR
...
for cls in g.subjects(RDF.type, RDFS.Class):
    superclass = g.objects(cls, RDFS.subClassOf)
...
for cls in all_classes:
    for sub in g.subjects(RDFS.subClassOf, cls):
        if sub not in all_classes:
            all_classes.append(sub)

...
Original file is located at
    https://colab.research.google.com/drive/1dbtraOcY_tyUMC43irCYlRmm8xDXzpdI
...
from rdflib import Graph, Namespace, RDFS, XSD, Literal

g = Graph()

VCARD = Namespace("http://www.w3.org/2001/vcard-rdf/3.0/")
FOAF = Namespace("http://xmlns.com/foaf/0.1/")
persons = Namespace("http://oeg.fi.upm.es/resource/persons#")

g.add((persons["Oscar"], RDFS.label, Literal("Oscar", datatype=XSD.string)))

g.add((persons["Oscar"], VCARD.Given, Literal("Oscar", datatype=XSD.string)))
g.add((persons["Oscar"], VCARD.Family, Literal("Corcho García", datatype=XSD.string)))
g.add((persons["Oscar"], VCARD.FN, Literal("Oscar Corcho García", datatype=XSD.string)))
g.add((persons["Oscar"], FOAF.email, Literal("oscar.corcho@upm.es", datatype=XSD.string)))

g.add((persons["JaneSmith"], RDFS.label, Literal("Jane", datatype=XSD.string)))
g.add((persons["JohnSmith"], RDFS.label, Literal("John", datatype=XSD.string)))

...
Original file is located at
    https://colab.research.google.com/drive/1i2y3ymjfClNn2RUA9glgXlhadXJRM2At
...
def person_subclass_bool(s):
    if s == PEOPLE.Person:
        return True

    for s, p, o in g.triples((s, RDFS.subClassOf, None)):
        if person_subclass_bool(o):
            return True

    return False

for s, p, o in g.triples((None, RDF.type, None)):
    if o == PEOPLE.Person or person_subclass_bool(o):

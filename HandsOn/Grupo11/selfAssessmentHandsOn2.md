...
Se realiza un análisis del dataset escogido (Estaciones de Cercanías de Madrid), así como un estudio sobre su estructura (nombre, código, descripción, localización, ficha técnica en formato pdf).
